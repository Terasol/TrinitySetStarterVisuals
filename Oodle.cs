...
namespace TrinitySetStarterVisuals
{
    ...
    public static class Oodle
    {
        ...
        {
            if (!File.Exists($"{System.Reflection.Assembly.GetEntryAssembly().Location}\\oo2core_6_win64.dll"))
            {
        ...
        {
            if (!File.Exists(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "oo2core_6_win64.dll")))
            {
                MessageBox.Show("'oo2core_6_win64.dll' not found in the executable folder! User must provide their own copy!");
            }
